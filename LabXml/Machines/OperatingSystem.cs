...
namespace AutomatedLab
{
    ...
    public class OperatingSystem
    {
        ...
        static OperatingSystem()
        {
            ...
            {
                throw new Exception(string.Format("Could not read 'ProductKeys.xml' file. Make sure the file exist in path '{0}'", productKeysXmlFilePath));
            }
            ...
            {
                //throw new Exception(string.Format("Could not read 'ProductKeysCustom.xml' file. Make sure the file exist in path '{0}'", productKeysCusomXmlFilePath));
            }
